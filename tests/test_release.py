...
@pytest.fixture
def release_env():
    return {"RELEASE_TAG": "auth-sdk-python-v0.1.1"}


def test_valid_release_identity(release_env):
    validate_release("0.1.1", release_env)
...
@pytest.mark.parametrize("source_version", ["auth-sdk-python-v0.1.1", "refs/tags/auth-sdk-python-v0.1.1"])
